      ...
      <div className=" course-info-top-wrapper ">
        ...
        {loading ? (
          ...
          <>
            ...
            <p className="pt-3.5">
              Get the most out of your course! Upgrade to get unlimited access
              to the course material, unlock both graded and non-graded
              assignments, and earn a verified certificate to showcase on your
              resume.
            </p>
